...
python run_experiment.py --ica --skyserver --dim 5  --verbose --threads 3 > ica-skyserver-clustering.log 2>&1
python run_experiment.py --ica --ausweather   --dim 6  --skiprerun --verbose --threads 3 > ica-ausweather-clustering.log   2>&1
python run_experiment.py --pca --skyserver --dim 8 --skiprerun --verbose --threads 3 > pca-skyserver-clustering.log 2>&1
python run_experiment.py --pca --ausweather   --dim 5  --skiprerun --verbose --threads 3 > pca-ausweather-clustering.log   2>&1
