...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', default=2**16, type=int, help='A random seed to set, if desired')
    ...
    if not args.no_set1:
        ds1_data = loader.SkyServerData(verbose=verbose, seed=seed)
        ds1_name = 'SkyServer'
        ds1_readable_name = 'SkyServer'
